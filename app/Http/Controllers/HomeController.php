...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        $staff_picks = Campaign::where('status',1)->staff_picks()->orderBy('id', 'desc')->take(8)->get();
        $new_campaigns = Campaign::where('status',1)->orderBy('id', 'desc')->paginate(20);
        $funded_campaigns = Campaign::where('status',1)->funded()->orderBy('id', 'desc')->take(8)->get();
